defmodule Jido.Chat.Slack.ReactionOptions do
  @moduledoc """
  ...
  @doc "Builds reaction options from a struct, keyword list, or map."
  ...
  @doc "Extracts transport options for Slack reaction calls."
